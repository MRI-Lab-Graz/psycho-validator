#!/usr/bin/env python3
"""
Generate a hybrid BIDS/PRISM demo dataset for psycho-validator testing.
Creates 'prism_demo' folder with 3 subjects, physiological data, and surveys.
"""
...
def main():
    ...
    dataset_description = {
        ...
        "DatasetType": "raw",
        "License": "CC0",
        "Authors": ["Psycho-Validator Team", "Another Author"],
        "Acknowledgements": "Generated by create_dummy_files.py",
        "HowToAcknowledge": "Please cite this repo.",
        "Funding": ["Internal"],
    ...
    create_tsv(os.path.join(ROOT_DIR, "participants.tsv"), participants_headers, participants_rows)
    
    participants_json = {
        "age": {"Description": "Age of the participant", "Units": "years"},
        "sex": {"Description": "Sex of the participant", "Levels": {"M": "male", "F": "female"}},
        "group": {"Description": "Experimental group", "Levels": {"control": "Control Group", "experimental": "Experimental Group"}}
    }
    ...
    for sub in subjects:
        ...
        survey_headers = ["q1", "q1_responseTime", "q2", "q2_responseTime", "q3", "q3_responseTime"]
        survey_rows = [
            ["5", "1.2", "3", "0.8", "4", "1.5"]
        ]
        create_tsv(os.path.join(survey_dir, f"{survey_filename}.tsv"), survey_headers, survey_rows)
        ...
        survey_metadata = {
            ...
            "q1_responseTime": {
                "Description": "Response time for q1",
                "Units": "s"
            },
            "q2": {
            ...
            "q2_responseTime": {
                "Description": "Response time for q2",
                "Units": "s"
            },
            "q3": {
            ...
            "q3_responseTime": {
                "Description": "Response time for q3",
                "Units": "s"
            }
        }
        create_json(os.path.join(survey_dir, f"{survey_filename}.json"), survey_metadata)
        ...
        create_tsv(os.path.join(deriv_dir, f"{hrv_filename}.tsv"), hrv_headers, hrv_rows)

        # Sidecar
        hrv_metadata = {
            "Description": "Heart Rate Variability metrics derived from ECG",
            "Sources": [os.path.join(f"sub-{sub}", f"ses-{ses}", "beh", f"{physio_filename}.tsv.gz")],
            "Software": {
                "Name": "Cubios",
                "Version": "3.0"
            }
